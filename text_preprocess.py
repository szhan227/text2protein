...
if __name__ == '__main__':
    ...
    try:
        ...
        test_toks = tokenizer(test_text, return_tensors="pt", add_special_tokens=False, max_length=512, padding='max_length').to(device)
        test_emb = llama_model.model.embed_tokens(test_toks.input_ids)
